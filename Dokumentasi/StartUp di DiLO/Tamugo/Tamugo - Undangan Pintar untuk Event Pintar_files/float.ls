...
_ZLDSCREENNAME="tamugo"; //No I18N
_ZLDEMBEDNAME="tamugo";  //No I18N
_ZLDUTSSERVER="vts.zohopublic.com";  //No I18N
_LANG = "en";  //No I18N
var _CCODE= "GB"; //No I18N
...
function ZloadFiles()
{
  ...
  ocss.rel ="stylesheet";
  ocss.href = "https://css.zohostatic.com/salesiq/May_25_2018_2_https/styles/floatsupportbtn.css";  
  ...
  try
  {
		...
		if(ie && document.compatMode!="CSS1Compat")
		{
				var ocss = document.createElement("link");
				ocss.rel ="stylesheet";
				ocss.href = "https://css.zohostatic.com/salesiq/May_25_2018_2_https/styles/floatiebtnfix.css";  
				headArr[0].appendChild(ocss);
		}
  ...
  oscript.src="https://js.zohostatic.com/salesiq/May_25_2018_2_https/js/track.js";  //No I18N
  headArr[0].appendChild(oscript);//No I18N
}
...
function ZaddEvent()
{
  	...
  	var iframeurl = "https://salesiq.zohopublic.com/tamugo/chatwindow.ls?";  	
    var _zldcpage = "https://tamugo.com/"; 
  ...
  _ZSIQ.initSIQAPI = _ZSIQ.initSIQAPI || function()   //No I18N
  {
    ...
    var floatcookie = readCookie('zld201979000000002043float');//No I18N
	...
	lsid:'201979000000002043' // NO I18N
	};
	try
	{
  ...
  _ZSIQ.initFloat = function()//No I18N
  {
	Float.newembed = true;//No I18N
        ...
        Float.lsobject={"autochat":"false","clickchat":"false","name":"","email":"","ques":"","department":"","embedname":"tamugo","lsid":"201979000000002043","bgcolor":"#76323f","oncontent":"Click to chat","icon":"7","buttontheme":"customize","oncontentcolor":"#FFFFFF","status":"on","statustext":"Online","serverurl":"https://salesiq.zohopublic.com","url":"https://salesiq.zohopublic.com/tamugo/chatwindow.ls?","floatposition":"bottomright","top":"0","bottom":"0","left":"0","right":"0","flipicon":"false","aligntoright":"false","floatmeasurement":"px","headercolor":"#76323f","sbicobg":"#76323f","fltsize":"medium","mobileoncontent":"common.mobile.chat","ipadoncontent":"infomsg.mobile.chatwithus","mobileoffcontent":"infomsg.mobile.offline"}; 
        Float.lsobject["imgurl"] = "https://img.zohostatic.com/salesiq/May_25_2018_2_https";  
		...
		Float.lsobject["screenname"]="tamugo" ;
		...
		Float.lsobject.currdomain = "tamugo.com";
		Float.lsobject["float_fkey"]="0_201979000000002043"; 
		Float.lsobject["css_fkey"]="0_201979000000002043"; 
		Float.lsobject.themeid = "4"	; //No I18N
   		Float.lsobject.embedtheme=""; //NO I18N 
